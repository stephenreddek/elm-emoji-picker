...
iconList : List ( Category, String -> Html msg )
iconList =
    [ people
    , nature
    , foods
...
frequentlyUsed : String -> Html msg
frequentlyUsed className =
    svg
        [ class "category-icon"
...
activity : ( Category, String -> Html msg )
activity =
    ( { id = "activity"
      , name = "Activities"
...
flags : ( Category, String -> Html msg )
flags =
    ( { id = "flags"
      , name = "Flags"
...
foods : ( Category, String -> Html msg )
foods =
    ( { id = "foods"
      , name = "Food & Drink"
...
nature : ( Category, String -> Html msg )
nature =
    ( { id = "nature"
      , name = "Animals & Nature"
...
objects : ( Category, String -> Html msg )
objects =
    ( { id = "objects"
      , name = "Objects"
...
people : ( Category, String -> Html msg )
people =
    ( { id = "people"
      , name = "Smileys & People"
...
places : ( Category, String -> Html msg )
places =
    ( { id = "places"
      , name = "Travel & Places"
...
symbols : ( Category, String -> Html msg )
symbols =
    ( { id = "symbols"
      , name = "Symbols"
